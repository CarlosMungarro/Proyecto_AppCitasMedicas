...
class DisponibilidadActivity : AppCompatActivity() {
    ...
    // ✅ ahora usamos UID String (Firebase), NO Long
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Lee UID desde SharedPreferences
        ...
        // Datos de prueba vinculados al UID del médico (opcional)
    ...
    private fun validarHorarioDia(diaSemana: Int, horarios: List<String>, nombreDia: String): ValidationResult {
        ...
        val horariosLimpios = horarios.map {
            it.replace(" am", "", true).replace(" pm", "", true).trim()
        }.sorted()
    ...
    private fun mostrarDialogoConflicto(resultado: ValidationResult, dia: String) {
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage("No puedes guardar esta disponibilidad porque tienes citas programadas fuera del horario:\n\n$citasTexto")
